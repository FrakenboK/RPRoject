#' Render metrics outputs for Shiny
#'
#' Functions for rendering metrics visualizations and summaries in Shiny app
#'
#' @param metrics_reactive Reactive value containing metrics
#' @param df_reactive Reactive value containing data frame
#'
#' @return Shiny render functions
#' @export
render_metrics_summary <- function(metrics_reactive) {
  renderText({
...
#' Render countries plot
render_countries_plot <- function(metrics_reactive) {
  renderPlot({
    metrics <- metrics_reactive()
...
#' Render ASN plot
render_asn_plot <- function(metrics_reactive) {
  renderPlot({
    metrics <- metrics_reactive()
...
#' Render data table
render_data_table <- function(df_reactive) {
  DT::renderDataTable({
    df <- df_reactive()
